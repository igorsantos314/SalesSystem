...
class interfaceSales(Frame):
    ...
    def __init__(self):
        ...
        self.lblAmount.place(x=335, y=553)
        ...
        self.paintingInformation = Label(text='', font='Arial 18 bold', bg='DarkRed', fg='white', width=28, height=12)
        ...
        self.lblShowAmount.place(x=10, y=508)

        self.entryAmountProd = Entry(font='Courier 15 bold', bg='darkred', fg='white')
        self.entryAmountProd.place(x=134, y=512)
